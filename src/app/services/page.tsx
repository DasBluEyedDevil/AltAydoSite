...
const services = [
  ...
  },
  {
    ...
    description: 'Elite combat pilots and security personnel providing protection for high-value shipments and VIP transports.',
    detailedDescription: 'Through our partnership with Rogue Squadron, we offer top-tier security operations for all cargo classes. From routine shipping lanes to high-risk sectors, our combat-trained pilots and state-of-the-art fighter craft ensure your assets arrive intact.',
    image: '/images/Sabre_Firing_Concept.jpg',
    icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
    stats: [
      { label: 'Combat Rating', value: 'S-Class' },
      { label: 'Security Incidents', value: '0.01%' },
      { label: 'Fighter Fleet', value: '28+' }
    ]
  },
];
    ...
    <div ref={containerRef} className="relative min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="ml-4 font-mono text-[rgba(var(--mg-text),0.8)]">{new Date().toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</span>
        </div>
      </motion.div>
